...
$(function() {
    ...
    var styles = [
        ...
        // highlight government buildings
        {
...
function addMarker(place)
{
    // TODO
    // set the location
    var location = new google.maps.LatLng(parseFloat(place.latitude), parseFloat(place.longitude));

    // marker
    var image = "img/Newspaper.png";
...
function articles(marker, query)
{
    ...
    .done(function(data, textStatus, jqXHR) {
        ...
        for (var i = 0; i < data.length; i++) {
            list += "<li><a href='" + data[i].link + "' target=_blank>" + data[i].title + "</a></li>";
        }
